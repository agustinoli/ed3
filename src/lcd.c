...
/********************************************************************//**
 * @brief		Configura los pines necesarios para el control del lcd
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Configura las estructuras de SPI necesarias para el lcd
 * @return       none
 *********************************************************************/
void config_lcd_spi(){
...
/*************************************************************
 * 	\b<Funciones provistas por la libreria del fabricante
 * 	portadas por los alumnos para su uso con CMSIS >
 *************************************************************/

/********************************************************************//**
 * @brief		Realiza las configuraciones sobre el driver del LCD
 * 				escribiendo los registros que admiten el modo más comodo
...
/********************************************************************//**
 * @brief		Funcion que envia una palabra por SPI.
 * @param[in]    value el valor numerico del dato.
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Funcion que permite escribir un registro con un dato
 * @param[in]   cmd_value  Direccion del registro a escribir
 * @param[in]	data_value	Valor numerico del dato
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Establece los limites de direcciones GRAM a utilizar para
 * 				la escritura de la misma.
 * @param[in]   xs Coordenada de inicio en x
 * @param[in]	ys Coordenada de inicio en y
 * @param[in]   xe Coordenada de fin en x
 * @param[in]	ye Coordenada de fin en y
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Funcion que posiciona el puntero de escritura de GRAM
 * @param[in]   x_pos	Coordenada en x
 * @param[in]	y_pos	Coordenada en y
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Dibuja la pantalla en un color
 * @param[in]   colour	Valor del color en RGB, puede ser predefinido
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Dibuja el pixel de coordenada (x_pos,y_pos) con el color
 * @param[in]   x_pos	Coordenada en x
 * @param[in]	y_pos	Coordenada en y
 * @param[in]	colour	Valor del color en RGB, puede ser predefinido
 * @return       none
...
/********************************************************************//**
 * @brief		Dibuja un triangulo de vertices (x1,y1),(x2,y2),(x3,y3)
 * @param[in]   xi	Coordenada en x del vertice i
 * @param[in]	yi	Coordenada en y del vertice i
 * @param[in]	fill	Indica si debe rellenarse o no la figura
 * @param[in]	colour	Valor del color en RGB, puede ser predefinido
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Dibuja una linea entre vertices (x1,y1),(x2,y2)
 * @param[in]   xi	Coordenada en x del vertice i
 * @param[in]	yi	Coordenada en y del vertice i
 * @param[in]	colour	Valor del color en RGB, puede ser predefinido
 * @return       none
 ...
 * @param[in]   xc	Coordenada en x del centro
 * @param[in]	yc	Coordenada en y del centro
 * @param[in]	radius	Indica el valor en pixeles del radio
 * @param[in]	fill	Indica si debe rellenarse o no la figura
 * @param[in]	colour	Valor del color en RGB, puede ser predefinido
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Dibuja un rectangulo entre los vertices (x1,y1),(x2,y2)
 * @param[in]   xi	Coordenada en x del vertice i
 * @param[in]	yi	Coordenada en y del vertice i
 * @param[in]	fill	Indica si debe rellenarse o no la figura
 * @param[in] 	type	indica si se trata de un cuadrado o rectangulo
 * @param[in]	colour	Valor del color en RGB, puede ser predefinido
 * @param[in] back_colour	Color de fondo en caso de usar NO en fill
 * @return       none
 *********************************************************************/
...
/*************************************************************
 * 	\b<Funciones para el dibujo de chars y strings >
 *************************************************************/

/********************************************************************//**
 * @brief		Imprime una secuencia de caracteres
 * @param[in]   x_pos	Coordenada en x de inicio de string
 * @param[in]	y_pos	Coordenada en y de inicio de string
 * @param[in]	font_size tamaño de "pixel" de caracter.
 * @param[in]	colour	Valor del color en RGB, puede ser predefinido
 * @param[in]	ch Cadena de texto
 * @return       none
 *********************************************************************/
void print_str(unsigned char x_pos, unsigned char y_pos,
		unsigned char font_size, unsigned long colour, char *ch)
{
  char *aux =ch;
  int tam=0;
  do{
...
/********************************************************************//**
 * @brief		Realiza algunas figuras para probar las funciones de dibujo
 * @return       none
 *********************************************************************/
 ...
 * @param[in]	font_size tamaño de "pixel" de caracter.
 * @param[in]	colour	Valor del color en RGB, puede ser predefinido
 * @param[in]	ch Valor del caracter a imprimir
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Funcion privada que imprime los pixeles de un char
 * 					segun la fuente.
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Funcion que imprime rectangulos de colores para probar
 * 					los mismos.
 * @return       none
 *********************************************************************/
void test_colours()
...
void draw_alert(){
	TFT_fill(Black);
	Draw_Circle(res_x/2, res_y/2, 100, YES, Yellow);
	Draw_Rectangle(res_x/2+12, res_y/2+40, res_x/2-12, res_y/2-30,YES, SQUARE, Black, Black);
	Draw_Rectangle(res_x/2+12, res_y/2+12-50, res_x/2-12, res_y/2-12-50,YES, ROUND, Black, Black);
}


/*************************************************************
 * 	\b<Funciones auxiliares para el manejo de datos>
 *************************************************************/
