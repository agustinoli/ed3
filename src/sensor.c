...
/********************************************************************//**
 * @brief		Configura las estructuras de timer para el uso del sensor
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Configura los pines necesarios para el uso del sensor
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Configura las interrupciones externas que genera el sensor
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Inicializa el timer del sensor
 * @return       none
 *********************************************************************/
...
/********************************************************************//**
 * @brief		Realiza la salida de las opciones de color hacia el sensor
 * @param[in]    color   Uno de los modos de color, puede ser:
 * 									SENSOR_CFG_RED,
 * 									SENSOR_CFG_GREEN,
 * 									SENSOR_CFG_BLUE,
 * 									SENSOR_CFG_CLEAR.
